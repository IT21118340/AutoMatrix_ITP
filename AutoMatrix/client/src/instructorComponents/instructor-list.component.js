...
const Instructor = (props) => (
  <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
    <td className='px-6 py-4 text-base font-medium text-blue-950'>
      {props.instructor.fullName}
    </td>
    <td className='px-6 py-4 text-base font-medium text-blue-950'>
      {props.instructor.nic}
    </td>
      ...
      <div class='flex justify-center'>
        <div class=''>
          <button
            ...
            onClick={() => {
              props.gotoUpdateInstructor(props.instructor._id)
            }}
          >
            <div class=''>
              <svg
...
export class InstructorList extends Component {
  ...
  refreshTable() {
    axios
      .get('http://localhost:80/instructor/')
      .then((response) => {
  ...
  deleteInstructor(id) {
    axios.delete('http://localhost:80/instructor/' + id).then((response) => {
    ...
    return this.state.instructor.map((currentinstructor) => {
      return (
        <Instructor
          ...
          gotoUpdateInstructor={this.gotoUpdateInstructor}
  ...
  searchInstructorList() {
    return this.state.instructor.map((currentinstructor) => {
      if (this.state.searchInstructor == currentinstructor.nic) {
        return (
          <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
            <td className='px-6 py-4 text-base font-medium text-blue-950'>
                ...
                <div class=''>
                  {
                    <button
                      className='inline-flex items-center px-4 py-2 ml-1 text-sm font-medium text-white duration-100 bg-indigo-500 rounded-md hover:bg-blue-200'
                      onClick={() => {
                        this.gotoUpdateInstructor(currentinstructor._id)
                      }}
                    >
                      <div class=''>
                        <svg
  ...
  exportInstructor = () => {
    ...
    const inst = this.state.instructor.map((Instructor) => [
      Instructor.fullName,
      Instructor.nic,
          ...
          <div className='inline-block min-w-full py-2 sm:px-6 lg:px-8'>
            <div className='items-center overflow-hidden'>
              ...
              <div class=''>
                ...
                >
                  <Modal.Header
                    className='px-5 pt-4 border-2 shadow-md bg-gray-50'
                    closeButton
                  >
                    <div class=''>
