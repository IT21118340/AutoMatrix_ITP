...
export class InstructorDetails extends Component {
  ...
  onSubmit(e) {
    ...
    if (this.state.password != this.state.cpassword) {
      ...
      axios
        .put('http://localhost:80/instructor/' + this.state.id, instructor)
        .then((res) => {
          console.log(res)
  ...
  refreshForm() {
    axios
      .get('http://localhost:80/instructor/' + this.state.id)
                ...
                <div className=''>
                  <div class='grid grid-cols-1 gap-4 content-start pt-5 px-20'>
                    <div className='formdiv'>
                      ...
                      >
                        <p className='text-4xl font-semibold text-center text-black uppercase billheading'>
                          Instructor Details
                        </p>
