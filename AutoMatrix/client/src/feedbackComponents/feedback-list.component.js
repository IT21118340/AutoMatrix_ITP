      ...
      <div class='flex justify-center'>
        <div class=''>
          <button
            ...
            onClick={() => {
              props.gotoUpdateFeedback(props.feedback._id)
            }}
          >
            <div class=''>
              <svg
        ...
        <div class=''>
          <button
            ...
            onClick={() => {
              props.deleteFeedback(props.feedback._id)
            }}
          >
            <div class=''>
              <svg
...
export class FeedbackList extends Component {
  ...
  refreshTable() {
    axios
      .get('http://localhost:80/feedback/')
      .then((response) => {
  ...
  deleteFeedback(id) {
    axios.delete('http://localhost:80/feedback/' + id).then((response) => {
    ...
    return this.state.feedback.map((currentfeedback) => {
      return (
        <Feedback
          ...
          gotoUpdateFeedback={this.gotoUpdateFeedback}
  ...
  searchFeedbackList() {
    return this.state.feedback.map((currentfeedback) => {
      if (this.state.searchFeedback == currentfeedback.instructor) {
        return (
          <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
            <td className='px-6 py-4 text-base font-medium text-blue-950'>
                ...
                <div class=''>
                  {
                    <button
                      className='inline-flex items-center px-4 py-2 ml-1 text-sm font-medium text-white duration-100 bg-indigo-500 rounded-md hover:bg-blue-200'
                      onClick={() => {
                        this.gotoUpdateFeedback(currentfeedback._id)
                      }}
                    >
                      <div class=''>
                        <svg
  ...
  exportFeedback = () => {
    ...
    const fed = this.state.feedback.map((Feedback) => [
      Feedback.feedback,
      Feedback.instructor,
    ])
